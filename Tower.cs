...
namespace TD
{
    class Tower
    {
        ...
        Texture2D towerTexture, baseTexture;
        bool isAlive;
        float rotation;
        float radius;
        float smallestRange;
        ...
        public Tower(int level, Vector2 position, Texture2D baseTexture, Texture2D towerTexture)
        {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if (isAlive)
            {
                ...
                spriteBatch.Draw(towerTexture, center, null, Color.White, rotation, origin, 1.0f, SpriteEffects.None, 0f);
            }
